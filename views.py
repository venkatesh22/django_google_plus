...
from django_google_plus import conf
...
#    redirect_to = request.REQUEST.get(redirect_field_name, '')
    if request.method == "POST":
        ...
        try:
            ...
            oauth_flow = flow_from_clientsecrets(CLIENT_SECRETS, scope='https://www.googleapis.com/auth/plus.me https://www.googleapis.com/auth/userinfo.email')
